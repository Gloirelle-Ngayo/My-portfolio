        ...
        <section id="accueil" className="min-h-screen flex items-center justify-center bg-base-100">
            <div className="container mx-auto px-4 flex flex-col md:flex-row items-center justify-center gap-8">
                ...
                <div className="text-center text-center mt-4">
                    ...
                    <p className="text-xl md:text-medium text-center md:text-justify">Je suis passionnée par les technologies et motivée par 
                    ...
                    <div className='flex justify-center gap-4 mt-8'>
                        <button className='px-5 py-1 rounded-lg border-2 border-gradient-to-r from-primary/90 via-secondary/90 to-accent/90 p-[2px] hover:opacity-90 transition-all duration-300'>
                            <div className='bg-base-100 rounded-lg'>
                                <Link href="#contact">
                                    <span className="block px-4 py-2 bg-gradient-to-r from-primary/90 via-secondary/90 to-accent/90 bg-clip-text text-transparent hover:opacity-90">Contactez-moi</span>
                                </Link>
                            </div>
                        </button>
                        <button className='px-5 py-1 rounded-lg border-2 border-gradient-to-r from-primary-800 via-secondary/90 to-accent/90 p-[2px] hover:opacity-90 transition-all duration-300'>
                            <div className='bg-base-100 rounded-lg'>
                                <a href="/assets/Cv_Ngayo_G.pdf" download="Cv_Ngayo_G.pdf">
                                    <span className="block px-4 py-2 bg-gradient-to-r from-primary/90 via-secondary/90 to-accent/90 bg-clip-text text-transparent hover:opacity-90">Télécharger mon CV</span>
                                </a>
                            </div>
                        </button>
                    </div>
